...
const PATTERNS: Record<string, Record<number, PatternDef>> = {
...
const resolvePattern = (pattern: string | Partial<PatternDef>, grid: number): PatternDef => {
...
export interface LatticeLoaderProps {
  ...
  pattern?: string | Partial<PatternDef>;
  grid?: 3 | 4;
  shape?: "round" | "square";
  color?: string;
  doneColor?: string;
...
export default function LatticeLoader({
  ...
  markRef.current = mark as "done" | "error";
