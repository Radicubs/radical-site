...
const resolveFontSize = (value: number | string, container: HTMLElement, fontWeight: number, fontFamily: string): number => {
...
const waitForFonts = async (font: string): Promise<void> => {
  ...
  try {
    ...
    // ignore font-loading failures; canvas falls back to whatever font resolves
  }
...
const ParticleText = ({
  ...
  useEffect(() => {
    ...
    const pointer: PointerState = { active: false, x: 0, y: 0, smoothX: 0, smoothY: 0 };
