...
type LineSidebarProps = {
  ...
  /** Controlled active index — when provided, overrides internal click-driven state (e.g. to sync with scroll position). */
...
export default function LineSidebar({
  ...
  const resolvedActive = activeIndex ?? internalActive;
