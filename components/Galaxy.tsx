...
export default function Galaxy({
  ...
  useEffect(() => {
    ...
    const moveTarget: HTMLElement | Window = interactionTarget === 'window' ? window : ctn;
    const leaveTarget: HTMLElement = interactionTarget === 'window' ? document.documentElement : ctn;
    if (mouseInteraction) {
      moveTarget.addEventListener('mousemove', handleMouseMove as EventListener, { passive: true });
