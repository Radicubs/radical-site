...
export default async function JourneyPage() {
  const journeyImages = await getJourneyImages();
        ...
        <div className="wrap">
          ...
          <div className="journey-list">
            {[...journeySeasons].reverse().map((season, index) => {
              const image = journeyImages[season.year] || season.image;
              return (
                  ...
                  <article className="journey-card" data-tilt-card>
                    <div className="journey-copy">
                      ...
                      <div className="journey-data">
                        <span><small>Official record</small>{season.record}</span>
                        {season.districtRank && <span><small>District rank</small>{season.districtRank}</span>}
                      </div>
