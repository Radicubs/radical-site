...
export interface ApiCorporateSponsorCorporateSponsor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::corporate-sponsor.corporate-sponsor", "oneToOne", "admin::user"> &
      Attribute.Private;
    updatedBy: Attribute.Relation<"api::corporate-sponsor.corporate-sponsor", "oneToOne", "admin::user"> &
      Attribute.Private;
  };
}
...
export interface ApiIndividualSponsorIndividualSponsor extends Schema.CollectionType {
  collectionName: "individual_sponsors";
  info: {
    singularName: "individual-sponsor";
    pluralName: "individual-sponsors";
    displayName: "Individual Sponsor";
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::individual-sponsor.individual-sponsor", "oneToOne", "admin::user"> &
      Attribute.Private;
    updatedBy: Attribute.Relation<"api::individual-sponsor.individual-sponsor", "oneToOne", "admin::user"> &
      Attribute.Private;
  };
}
...
export interface ApiMentorMentor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::mentor.mentor", "oneToOne", "admin::user"> & Attribute.Private;
    updatedBy: Attribute.Relation<"api::mentor.mentor", "oneToOne", "admin::user"> & Attribute.Private;
  };
}
