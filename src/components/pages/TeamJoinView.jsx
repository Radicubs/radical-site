...
import { allMembers } from '../../lib/api.js';
      ...
      <section className="px-6 md:px-16 lg:px-24 mb-16 max-w-6xl mx-auto">
        <div className="mb-12">
          ...
          <p className="text-[#d3d3d3] text-lg leading-relaxed max-w-2xl">
            Meet the students driving the future. No prior experience required. Just a willingness to
            learn, work hard, and be radical.
          </p>
        </div>
      </section>
