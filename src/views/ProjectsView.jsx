...
import { Card, SectionHeader } from '../shared/ui.jsx';

// 4. PROJECTS & IMPACT VIEW
const ProjectsView = () => {
  return (
    <div className="w-full pt-24 bg-[#101215]">
      <section className="px-6 md:px-16 lg:px-24 mb-16 max-w-7xl mx-auto">
        <SectionHeader title="Projects & Impact" subtitle="Impacting 2,500+ people annually through outreach, mentorship, and advocacy." />
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="bg-[#101215] rounded-lg p-8 border border-[#2c303a] card-hover flex flex-col">
              ...
              <div className="mt-auto pt-6 border-t border-[#2c303a]">
                <a href="mailto:radicubs@gmail.com" className="inline-block w-full text-center font-mono font-bold bg-[#5ddb27] text-[#101215] py-3 rounded hover:bg-white transition-colors uppercase tracking-wider text-sm">
      ...
      <section className="px-6 md:px-16 lg:px-24 mb-24 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Card>
            <div className="text-[#5ddb27] mb-4"><Cpu size={32} /></div>
          ...
          <Card>
            <div className="text-[#5ddb27] mb-4"><BookOpen size={32} /></div>
          ...
          <Card>
            <div className="text-[#5ddb27] mb-4"><Users size={32} /></div>
          ...
          <Card>
            <div className="text-[#5ddb27] mb-4"><Zap size={32} /></div>
