...
import { SectionHeader, Card } from '../shared/ui.jsx';
import { blogPosts } from '../shared/data.js';

// 1.5 BLOG LIST & POST VIEW (Data Accurate System)
      ...
      <div className="max-w-7xl mx-auto">
        {blogPosts.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.map((post) => (
              <Card key={post.id} onClick={() => navigate('blogPost', { postId: post.id })} className="flex flex-col h-full !p-0 overflow-hidden cursor-pointer">
