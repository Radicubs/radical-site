...
import { ArrowRight, Target, Globe, Heart, Users } from 'lucide-react';
            ...
            <div className="space-y-4">
              <Card className="flex items-center gap-4 border-[#2c303a] bg-[#1b1d23]">
                ...
                <div>
                  ...
                  <p className="text-[#a9a9a9] text-sm">Our members represent a global perspective, with a majority being first or second-generation immigrants.</p>
                </div>
              </Card>
              <Card className="flex items-center gap-4 border-[#2c303a] bg-[#1b1d23]">
                ...
                <div>
                  ...
                  <p className="text-[#a9a9a9] text-sm">A safe, welcoming environment where authenticity is celebrated alongside engineering.</p>
                </div>
              </Card>
              <Card className="flex items-center gap-4 border-[#2c303a] bg-[#1b1d23]">
                ...
                <div>
                  ...
                  <p className="text-[#a9a9a9] text-sm">Active partners in promoting and sustaining female participation in STEM fields.</p>
                </div>
              </Card>
            </div>
          </div>
