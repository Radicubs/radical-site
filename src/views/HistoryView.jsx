...
const HistoryView = () => {
  const seasonsTimeline = [
    { year: "2026", game: "Rebuilt", robot: "Chimera", description: "Data pending synchronization with team records.", awards: "Creativity Award, Spirit Award" },
    { year: "2025", game: "Reefscape", robot: "Robot Name TBD", description: "Data pending synchronization with team records.", awards: "" },
    { year: "2024", game: "CRESCENDO", robot: "Schrödinger", description: "Data pending synchronization with team records.", awards: "Regional Competitor" },
    { year: "2023", game: "CHARGED UP", robot: "Robot Name TBD", description: "Data pending synchronization with team records.", awards: "Judges Award" },
    { year: "2022", game: "RAPID REACT", robot: "Robot Name TBD", description: "Data pending synchronization with team records.", awards: "Gracious Professionalism Award" },
    { year: "2021", game: "INFINITE RECHARGE", robot: "Robot Name TBD", description: "Data pending synchronization with team records.", awards: "" },
    { year: "2019", game: "DESTINATION: DEEP SPACE", robot: "Robot Name TBD", description: "Data pending synchronization with team records.", awards: "Highest Rookie Seed x2, Rookie Inspiration, Rookie All-Star" }
  ];
    ...
    <div className="w-full pt-24 px-6 md:px-16 lg:px-24 bg-[#101215] min-h-screen pb-24 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative timeline-container mt-16">
        {seasonsTimeline.map((item, i) => {
          const isLeft = i % 2 === 0;
          return (
            <div key={i} className={`relative flex items-center justify-between md:justify-normal mb-16 fade-in-up w-full ${isLeft ? 'md:flex-row-reverse' : ''}`} style={{ animationDelay: `${i * 0.1}s` }}>
              ...
              <div className={`w-[calc(100%-40px)] md:w-[calc(50%-40px)] ml-auto md:ml-0 ${isLeft ? 'md:mr-auto md:pr-8' : 'md:ml-auto md:pl-8'}`}>
